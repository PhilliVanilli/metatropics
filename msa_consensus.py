...
def main(infile, log_file, chosen_ref_file, threads,
    ...
    project_dir = pathlib.Path(sample_fastq).parent.parent
    sample_dir = pathlib.Path(project_dir, "samples", raw_sample_name)
    ...
    for k, v in reference_d.items():
        ...
        if len(fasta_msa_d) == 0:
            ...
            # print(y)
            norm_depth_list = [x/total_basecount*1000000 for x in depth_list]
            # print(depth_list)
